...
\paragraph{}
Como se pude ver, podemos modificar las imagenes que aparecen en el menú o las posiciones de los botones.
...
máxima de este, velocidad en marcha atrás, aceleración, desaceleración y ángulo de giro. También todas las imagenes que representan
al jugador.
...
\begin{itemize}
    ...
    indicaramos los tiles que componen el circuito, así como la característica de estos.
...
\paragraph{}
En el caso de que se colisione con un tile que no es atravesable pero es del tipo que realentizaban la velocidad, únicamente
