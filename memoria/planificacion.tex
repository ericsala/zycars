...
propuestas y la deliveración sobre las mismas, se decidió realizar este proyecto.
...
\begin{itemize}
    ...
    ameno y llevadero, se realizaban problemas ya resuelto en otros lenguajes.
    ...
    aprendizaje se realizaban pequeñas aplicaciones sencillas, para asentar bien los conociminetos.
\end{itemize}

\section{Fase de desarrollo}

\paragraph{}
Tras la consecución de las etapas anteriores, se comenzó el desarrollo del proyecto. Esta etapa del desarrollo es la mas extensa de 
todas, como es comprensible. Y la que más subetapas contiene, las principales son la siguientes:
...
\begin{itemize}
    ...
    \item \textbf{Carga de escenario}: carga de los circuitos que comprondría el juego de forma que no fuera necesario tocar código
    ...
    escenario, así como con otros elementos del juego como pueden ser items u otros vehículos.
    
    \item \textbf{Items}: implementación del comportamiento y efecto que producirían cada uno de los items que están disponibles en el juego.
    
    \item \textbf{Inteligencia articial}: planteamiento y desarrollo de los vehículos que serían manejados por la inteligencia 
    artificial, estos deberían de se capaces de evitar obstaculos, realizar recorridos y lanzar items.
...
a la de desarrollo, ya que conforme se implementan nuevas funcionalidades, cada un debía ser probada exahustivamente en cualquiera
...
\begin{figure}[H]
  \label{gant1}
  \begin{center}
    \includegraphics[scale=0.35]{imagenes/planificacion/gant1.png}
  \end{center}
...
\begin{figure}[H]
  \label{gant2}
  \begin{center}
    \includegraphics[scale=0.35]{imagenes/planificacion/gant2.png}
  \end{center}
